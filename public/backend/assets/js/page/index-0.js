...
var statisticsChartElement = document.getElementById("myChart");

if (statisticsChartElement && window.Chart) {
  var statistics_chart = statisticsChartElement.getContext('2d');
...
if ($('#visitorMap').length && $.fn.vectorMap) {
...
if ($('#myWeather').length && $.simpleWeather) {
  getWeather();
